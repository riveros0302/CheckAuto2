...
export const generatePDF = async (data) => {
  ...
  <head>
    <style>
      body {
        ...
        margin: 0px;
        background-image: url('https://firebasestorage.googleapis.com/v0/b/checkauto-3f0c2.appspot.com/o/Utilidades%2FHECKAUTO.png?alt=media&token=5ff2b94d-5bb9-4748-a554-3bcc1e6d0f3e');
  ...
  <div class="qr-code">
  <img src="https://firebasestorage.googleapis.com/v0/b/checkauto-3f0c2.appspot.com/o/Utilidades%2Fqr-code-1024.png?alt=media&token=418e0b75-b55b-4b99-a0b1-715db1c61dca" alt="Código QR" width="120" height="120">
  </div>
  </div>
